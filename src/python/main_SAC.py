...
def draw_agent(env, policy, output_dir):
    ...
    imageio.mimsave(output_dir + "/movie.gif", frames)
...
for i_episode in itertools.count(1):
    ...
    while not done:
        if args.start_steps > total_numsteps:
            action = env.action_space.sample()["redispatch"]  # Sample random action
        else:
    ...
    print("Episode: {}, total numsteps: {}, episode steps: {}, reward: {}".format(i_episode, total_numsteps, episode_steps, round(float(episode_reward), 2)))
    ...
    if i_episode % 10 == 0 and args.eval is True:
        ...
        print("----------------------------------------")
        print("Test Episodes: {}, Avg. Reward: {}".format(episodes, round(float(avg_reward), 2)))
        print("----------------------------------------")
