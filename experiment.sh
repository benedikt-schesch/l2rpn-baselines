...
python3 src/python/main_sb3_imitation.py --config configs/imitation/single_episode/config_imitation_all_no_idx.json
python3 src/python/main_sb3_imitation.py --config configs/imitation/single_episode/config_imitation_all_timestep_idx.json
python3 src/python/main_sb3_imitation.py --config configs/imitation/single_episode/config_imitation_only_timestep_idx.json
